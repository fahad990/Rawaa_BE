...
exports.default = {
    createMessage: function createMessage(req, res, next) {
        ...
        return _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
            var targetId, userId, object, newMessage, title, _body;
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 6:
                            ...
                            //send notifications
                            title = "رسالة من الادارة";
                            _body = newMessage.text;

                            (0, _pushNotifications.send)(newMessage.targetUser, title, _body);
